    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="py-16 container mx-auto px-4">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="max-w-md w-full aspect-square rounded-xl overflow-hidden shadow-lg bg-gradient-to-br from-yellow-100/40 to-green-100/40">
            <img
              src="/images/yantras/lakshmi-yantra.jpg"
              alt="सिद्ध लक्ष्मी यंत्र"
          ...
          <div className="text-muted-foreground text-center text-lg mt-6 max-w-3xl leading-relaxed space-y-4">
            <p>
              लक्ष्मी यंत्र घर और व्यवसाय में धन, समृद्धि और सुख-शांति लाने के लिए अत्यंत प्रभावशाली है। 
              इसे स्थापित करने से वित्तीय बाधाएं दूर होती हैं और सकारात्मक ऊर्जा का संचार होता है।
            </p>
            ...
            <ul className="list-disc text-left inline-block space-y-2">
              <li>धन, समृद्धि और सुख-शांति में वृद्धि।</li>
              <li>घर और व्यवसाय में सकारात्मक ऊर्जा का संचार।</li>
              <li>आर्थिक बाधाओं और नकारात्मक प्रभावों से मुक्ति।</li>
          ...
          <p className="text-2xl font-semibold text-primary mt-8">₹899</p>
            ...
            onClick={() =>
              window.open(
                `https://wa.me/919760924411?text=${encodeURIComponent(
                  "मैं सिद्ध लक्ष्मी यंत्र खरीदना चाहता/चाहती हूँ।"
                )}`,
                "_blank"
              )
            }
