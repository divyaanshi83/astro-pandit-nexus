                    ...
                    <CardContent className="p-6 space-y-4">
                        ...
                        {result && (
                            <div className="mt-6 border-t pt-4 space-y-3">
                                <h2 className="text-xl font-semibold text-purple-700 text-center">Today's Insight</h2>
                                <p className="text-gray-700 whitespace-pre-line">{result}</p>

                                <h3 className="text-lg font-semibold text-purple-600 mt-4">Weekly Chart</h3>
                                <ul className="list-disc pl-6 text-gray-700">
                                    {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"].map((day) => (
                                        <li key={day}>{day}: {Math.random() > 0.5 ? "Lucky" : "Neutral"}</li>
                                    ))}
                                </ul>
                            </div>
                        )}
